...

;;; Generated autoloads from test/demo-tests.el

(register-definition-prefixes "test/demo-tests" '("demo-should-browse-" "hypb-should-browse-demo-was-called"))
...

;;; Generated autoloads from test/hbut-tests.el

(register-definition-prefixes "test/hbut-tests" '("hbut-tests"))
...

;;; Generated autoloads from test/hib-social-tests.el

(register-definition-prefixes "test/hib-social-tests" '("hib-social-should-browse-"))
...

;;; Generated autoloads from test/hmouse-drv-tests.el

(register-definition-prefixes "test/hmouse-drv-tests" '("hbut-"))
...

;;; Generated autoloads from test/hpath-tests.el

(register-definition-prefixes "test/hpath-tests" '("hpath-" "hypb-run-shell-test-command"))
...

;;; Generated autoloads from test/hy-test-coverage.el

(register-definition-prefixes "test/hy-test-coverage" '("hy-test-"))


;;; Generated autoloads from test/hy-test-dependencies.el

(register-definition-prefixes "test/hy-test-dependencies" '("hy-test-ensure-package-installed"))


;;; Generated autoloads from test/hy-test-helpers.el

(register-definition-prefixes "test/hy-test-helpers" '("hy-"))
...

;;; Generated autoloads from test/hyperbole-tests.el

(register-definition-prefixes "test/hyperbole-tests" '("hyperbole-key-bindings"))
...

;;; Generated autoloads from test/hyrolo-tests.el

(register-definition-prefixes "test/hyrolo-tests" '("hyrolo-tests--"))
...

;;; Generated autoloads from test/hywconfig-tests.el

(register-definition-prefixes "test/hywconfig-tests" '("hywconfig-tests--remove-"))
...

;;; Generated autoloads from test/hywiki-tests.el

(register-definition-prefixes "test/hywiki-tests" '("hywiki-tests--"))


;;; Generated autoloads from kotl/kcell.el

(autoload 'kcell:parse-cell-ref "kotl/kcell" "\
Parse CELL-REF string and return list of strings (<cell-id> <viewspec>).
If any item in the list is missing, it is nil.

(fn CELL-REF)")
(autoload 'kcell:ref-to-id "kotl/kcell" "\
...
(register-definition-prefixes "kotl/kcell" '("kcell"))


;;; Generated autoloads from test/kcell-tests.el

(register-definition-prefixes "test/kcell-tests" '("kcell-tests--"))


;;; Generated autoloads from kotl/kexport.el

(autoload 'kexport:koutline "kotl/kexport" "\
...
(autoload 'kexport:display "kotl/kexport" "\
...
(fn &optional SOFT-NEWLINES-FLAG)" t)
(autoload 'kexport:html "kotl/kexport" "\
...
(register-definition-prefixes "kotl/kexport" '("kexport:"))


;;; Generated autoloads from kotl/kfile.el

(autoload 'kfile:find "kotl/kfile" "\
Find a file FILE-NAME containing a kotl or create one if none exists.
Return the new kview.

(fn FILE-NAME)" t)
(autoload 'kfile:is-p "kotl/kfile" "\
...
(autoload 'kfile:view "kotl/kfile" "\
View an existing kotl version-2 file FILE-NAME in a read-only mode.

(fn FILE-NAME)" t)
(register-definition-prefixes "kotl/kfile" '("kfile:"))


;;; Generated autoloads from kotl/kfill.el

(register-definition-prefixes "kotl/kfill" '("kfill:" "prior-fill-prefix" "set-fill-prefix"))


;;; Generated autoloads from kotl/kimport.el
...
(autoload 'kimport:file "kotl/kimport" "\
...
(autoload 'kimport:insert-file "kotl/kimport" "\
...
(autoload 'kimport:insert-register "kotl/kimport" "\
...
(autoload 'kimport:aug-post-outline "kotl/kimport" "\
...
(fn IMPORT-FROM OUTPUT-TO &optional CHILDREN-FLAG)" t)
(autoload 'kimport:star-outline "kotl/kimport" "\
...
(fn IMPORT-FROM OUTPUT-TO &optional CHILDREN-FLAG)" t)
(autoload 'kimport:text "kotl/kimport" "\
...
(fn IMPORT-FROM OUTPUT-TO &optional CHILDREN-FLAG)" t)
(autoload 'kimport:copy-and-set-buffer "kotl/kimport" "\
...
(fn SOURCE)")
(register-definition-prefixes "kotl/kimport" '("kimport:"))


;;; Generated autoloads from kotl/klabel.el

(register-definition-prefixes "kotl/klabel" '("klabel" "kotl-label:"))


;;; Generated autoloads from kotl/klink.el

(autoload 'klink:create "kotl/klink" "\
...
(fn REFERENCE)" t)
(autoload 'klink:at-p "kotl/klink" "\
...
(register-definition-prefixes "kotl/klink" '("klink" "link-to-kotl"))


;;; Generated autoloads from kotl/kmenu.el

(register-definition-prefixes "kotl/kmenu" '("id-popup-kotl-menu" "kotl-"))


;;; Generated autoloads from kotl/kotl-mode.el

(autoload 'kotl-mode "kotl/kotl-mode" "\
The major mode used to edit and view koutlines.
Automatically invoked on files with a .kotl or .kot suffix.

It provides the following keys:
\\{kotl-mode-map}" t)
(autoload 'kotl-mode:example "kotl/kotl-mode" "\
...
(register-definition-prefixes "kotl/kotl-mode" '("delete-selection-pre-hook" "kotl-" "yank-"))


;;; Generated autoloads from test/kotl-mode-tests.el

(register-definition-prefixes "test/kotl-mode-tests" '("kotl-mode-" "setup-kotl-mode-example-test"))


;;; Generated autoloads from kotl/kotl-orgtbl.el

(register-definition-prefixes "kotl/kotl-orgtbl" '("kotl-mode" "orgtbl-tab"))


;;; Generated autoloads from kotl/kproperty.el

(register-definition-prefixes "kotl/kproperty" '("kproperty:"))


;;; Generated autoloads from kotl/kview.el

(autoload 'kview:char-invisible-p "kotl/kview" "\
Return t if the character after point is invisible/hidden, else nil.

(fn &optional POS)")
(register-definition-prefixes "kotl/kview" '("kcell-view:" "kotl-kview" "kview"))


;;; Generated autoloads from kotl/kvspec.el

(register-definition-prefixes "kotl/kvspec" '("kvspec:"))
