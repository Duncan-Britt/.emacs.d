...
(autoload 'org-transclusion-indent-mode "org-transclusion-indent-mode" "\
...
This is a minor mode.  If called interactively, toggle the
`Org-Transclusion-Indent mode' mode.  If the prefix argument is
...
To check whether the minor mode is enabled in the current buffer,
evaluate the variable `org-transclusion-indent-mode'.

The mode's hook is called both when the mode is enabled and when it is
disabled.

(fn &optional ARG)" t)
(autoload 'org-transclusion-indent-mode-setup "org-transclusion-indent-mode" "\
Set up auto-activation of `indent mode' in `org-mode' buffers.
Adds `post-command-hook' to detect when source overlays appear.")
(register-definition-prefixes "org-transclusion-indent-mode" '("org-transclusion-indent--"))
