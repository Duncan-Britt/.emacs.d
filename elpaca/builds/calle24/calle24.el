...
Calle 24 images."
  ...
  (let* ((calle24-pkg-dir (if-let (user-elpaca-repos-dir (bound-and-true-p elpaca-repos-directory))
                             (expand-file-name "calle24" user-elpaca-repos-dir)
                           (let ((calle24-pkg (car (map-elt package-alist 'calle24))))
                             (package-desc-dir calle24-pkg))))
